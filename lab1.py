...
Original file is located at
    https://colab.research.google.com/drive/18gSrtuvETwN4BJEXSGAlvJuUgvxBD3X1
...
# Prompt the user to enter their name, surname, age
name = input("Enter your name: ")
...
if number2 == 0:
    ...
    print("First number can be divided by the second.")
else:
    print("First number cannot be divided by the second.")
...
if side1 + side2 < side3 or side1 + side3 < side2 or side2 + side3 < side1:
    result = "Triangle cannot be built!"
else:
